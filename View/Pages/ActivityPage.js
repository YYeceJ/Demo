...
export default class ActivityPage extends Component {
    ...
    render() {
        return (
            <ScrollView style={[styles.container, {height: deviceHeight + this.state.keyboardHeight}]}>
                ...
                <ImageBackground source={require('../images/mainbg_v1.png')}
                    ...
                    <View style={styles.mainButton}>
                        ...
                        <View style={{width: size(260.413), flexDirection: 'row',marginTop:size(10),justifyContent:'space-between'}}>
                            ...
                            <TouchableOpacity style={styles.getCAPTCHAButton}>
                        ...
                        <TouchableOpacity style={styles.ruleViewButton} onPress={() => {
                            ...
                            console.log('----param----' +this.state.showRule)
                        }}>
                ...
                <View style={{height: this.state.keyboardHeight, width: deviceWidth}}></View>
                {
                    this.state.showRule
                        ?
                        <View style={styles.netAgeGift_ruleBox}>
                            <View style={styles.netAgeGift_ruleMain}>
                                ...
                                <ScrollView style={styles.netAgeGift_ruleDes}><Text style={styles.netAgeGift_ruleDesText}>1、促销期：2019年8月7日-2019年12月31日。
                                ...
                                <TouchableOpacity onPress={() => {
                                    ...
                                    <Image source={require('../images/close.png')} style={styles.ruleBox_closeBtn} />
                                </TouchableOpacity>
                            </View>
                        </View>
                        :
